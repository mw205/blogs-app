<x-layout>
    ...
    <main class="mx-5">
        <div class="flex justify-end mb-5 gap-2">
            <a class="inline-block rounded-sm border border-b-blue-500-600 bg-blue-600 px-12 py-3 text-sm font-medium text-white hover:bg-transparent hover:text-blue-600"
